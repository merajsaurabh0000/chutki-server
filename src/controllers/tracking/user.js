...
export const updateUser = async(req,reply)=>{
    try {
        ...
        const allowed = user => user.role === "Customer" ? ["name", "address", "liveLocation", "fcmToken"] : ["name", "liveLocation", "fcmToken"];
        ...
        if (user.role === "Customer") {
          ...
          const updateData = Object.fromEntries(Object.entries(req.body || {}).filter(([key]) => allowed(user).includes(key)));
